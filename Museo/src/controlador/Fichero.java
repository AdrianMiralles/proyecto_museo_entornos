...
public class Fichero  {
	public void generarXLS(ArrayList<Obra> consulta, String nombre) {
		...
		try {
			...
			fichero.close();
			JOptionPane.showMessageDialog(null, "Archivo creado con éxito", "Aviso", JOptionPane.PLAIN_MESSAGE);
		} catch (Exception e) {
			JOptionPane.showMessageDialog(null, "El archivo xls no ha podido ser creado por un error", "Error",
